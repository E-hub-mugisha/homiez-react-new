...
const Benefit = () => {
  return (
    <div>
      <section class="bg-secondary pt-5 pb-4 mt-5 mb-5">
        <div class="container py-lg-2 py-xl-4 py-xxl-5">
          <div class="row mt-1 pt-sm-2 pt-md-3 pt-lg-4">
            <div class="col-lg-5 mb-5 mb-lg-0">
              <h2 class="h1">Why Choose Us?</h2>
              <p class="pb-1 pb-md-0 mb-4 mb-md-5">Experience a seamless blend of creativity, technology, and reliability with our comprehensive services.</p>
              ...
              <div class="row row-cols-1 row-cols-sm-2">
                <div class="col">
                  ...
                  <div class="card border-0 mb-4">
                    <div class="card-body">
                      <svg class="d-block mb-3" width="36" height="36" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="18" cy="18" r="18" fill="#F8B400" />
                        <path d="M10 18L18 10L26 18L18 26L10 18Z" fill="#fff" />
                      </svg>
                      <h3 class="h4" style={{ maxWidth: '180px'}}>Creative Videography</h3>
                      <p class="card-text fs-sm">Capture your vision with our dynamic videography solutions tailored to your needs.</p>
                    </div>
                  </div>

                  <div class="card border-0 bg-primary text-light" data-bs-theme="dark">
                    <div class="card-body">
                      <svg class="d-block mb-3" width="36" height="36" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="18" cy="18" r="18" fill="#1E90FF" />
                        <path d="M12 12H24V24H12V12Z" fill="#fff" />
                      </svg>
                      <h3 class="h4" style={{ maxWidth: '180px'}}>Exceptional Photography</h3>
                      <p class="card-text fs-sm">Delivering high-quality images that bring your moments and ideas to life.</p>
                    </div>
                  </div>
                ...
                <div class="col d-flex flex-column pt-4 mt-sm-3">
                  ...
                  <div class="card border-0 order-sm-2 mb-4 mb-sm-0">
                    <div class="card-body">
                      ...
                      <h3 class="h4" style={{ maxWidth: '180px'}}>Web Development & Hosting</h3>
                      <p class="card-text fs-sm">Modern, responsive websites and reliable hosting to support your online presence.</p>
                    </div>
                  </div>

                  <div class="card border-0 bg-primary order-sm-1 mb-sm-4 text-light" data-bs-theme="dark">
                    <div class="card-body">
                      <svg class="d-block mb-3" width="36" height="36" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="18" cy="18" r="18" fill="#FF3B30" />
                        <path d="M18 12L12 24H24L18 12Z" fill="#fff" />
                      </svg>
                      <h3 class="h4" style={{ maxWidth: '180px'}}>IT Support</h3>
                      <p class="card-text fs-sm">Dependable IT support to keep your systems running smoothly and securely.</p>
                    </div>
                  </div>
