        ...
        <div>
            ...
            <section className="container">
                <div className="card border-0 bg-primary bg-opacity-10 position-relative overflow-hidden">
                    ...
                    <svg className="d-block position-absolute bottom-0 end-0 text-info opacity-20" width="140" height="86" viewBox="0 0 140 86" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg className="d-block position-absolute text-danger opacity-20" width="100" height="109" viewBox="0 0 100 109" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style={{ right: '60px', bottom: '62px' }}>
                            ...
                            <div className="col-md-4 col-lg-3 offset-lg-1 mb-3 mb-md-0">
                                ...
                                <div className="binded-content">
                                    ...
                                    <div className="binded-item active" id="author1">
                                        <img className="d-block rounded-circle mb-3" src="assets/img/avatar/13.jpg" width="86" alt="Lilianna Bocouse" />
                                    ...
                                    <div className="binded-item" id="author2">
                                        <img className="d-block rounded-circle mb-3" src="assets/img/avatar/14.jpg" width="86" alt="Darell Steward" />
                                        <h4 className="mb-0">Darell Steward</h4>
                                        <p className="fs-lg text-body-secondary mb-0">Project Manager</p>
                                    </div>

                                    {/*  Item  */}
                                    <div className="binded-item" id="author3">
                                        <img className="d-block rounded-circle mb-3" src="assets/img/avatar/15.jpg" width="86" alt="Annette Black" />
                                        <h4 className="mb-0">Annette Black</h4>
                                        <p className="fs-lg text-body-secondary mb-0">Lead Designer</p>
                                    </div>

                                    {/*  Item  */}
                                    <div className="binded-item" id="author4">
                                        <img className="d-block rounded-circle mb-3" src="assets/img/avatar/16.jpg" width="86" alt="Ralph Edwards" />
                                        <h4 className="mb-0">Ralph Edwards</h4>
                                        <p className="fs-lg text-body-secondary mb-0">CEO, Co-Founder</p>
                                    </div>
                                </div>
                            </div>
                  ...
                  "pagination": {
                    ...
                    "clickable": true
                                    ...
                                    <div className="swiper-wrapper">
                                        ...
                                        {/*  Item  */}
                                        <div className="swiper-slide" data-swiper-binded="#author1">
                                            <p className="text-dark lead mb-0">“Around provides us with the detailed and accurate data we need to make strategic decisions. All tools are constantly being improved and contain a lot of useful and interesting information. Thanks to Around, we can constantly analyze our big data quickly and efficiently.”</p>
                                        </div>

                                        {/*  Item  */}
                                        <div className="swiper-slide" data-swiper-binded="#author2">
                                            <p className="text-dark lead mb-0">“Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ac pretium dui. Aliquam rutrum justo lorem, in efficitur odio efficitur vel. Integer mattis, neque malesuada sagittis porttitor, enim tortor ullamcorper diam, id eleifend sem mauris at turpis. Curabitur sed nisi nec ligula dictum maximus eu ut ante.”</p>
                                        </div>

                                        {/*  Item  */}
                                        <div className="swiper-slide" data-swiper-binded="#author3">
                                            <p className="text-dark lead mb-0">“Quisque rutrum sit amet magna sit amet tristique. Vivamus rhoncus ac purus vitae convallis. Aliquam erat volutpat. Proin egestas, mauris ut semper semper, ipsum felis mattis ligula, et porttitor ante arcu nec ante. Aliquam congue est eu turpis sollicitudin, et ullamcorper tortor aliquam.”</p>
                                        </div>

                                        {/*  Item  */}
                                        <div className="swiper-slide" data-swiper-binded="#author4">
                                            <p className="text-dark lead mb-0">“Vestibulum faucibus lectus eget augue pharetra, quis semper lectus gravida. Vestibulum pretium in elit sed iaculis. Curabitur elementum turpis at ipsum molestie, id maximus odio tincidunt. Praesent id lacinia orci. Phasellus at varius arcu. Ut nec lobortis velit. Mauris vel risus quis lacus placerat fringilla.”</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="swiper-pagination position-relative bottom-0 pt-4 mt-2 mt-md-3" id="testimonials-bullets"></div>
            </section>
