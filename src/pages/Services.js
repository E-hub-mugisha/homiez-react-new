      ...
      <section class="container pb-5 mb-md-3 mb-lg-4 mb-xxl-5">
        <div class="row pb-md-4 pb-xl-5">
          <div class="col-md-6 mb-2 mb-md-0">
            <div class="card border-0 h-100 bg-size-cover bg-position-center" style={{ backgroundImage: 'url(assets/img/about/photo.jpg)' }}>
          ...
          <div class="col-md-6 col-xl-5 offset-xl-1">
            <div class="pt-4 pb-sm-4 ps-md-4 ps-xl-0">
              ...
              <div class="d-flex pb-3 mb-2 mb-xl-3">
                ...
                <div class="ps-3">
                  <h3 class="h5">Creative Videography</h3>
                  <p class="mb-0">Capture your vision with our dynamic videography solutions tailored to your needs.</p>
                </div>
              </div>
              <div class="d-flex pb-3 mb-2 mb-xl-3">
                <div class="text-body-secondary pt-1">02</div>
                <div class="ps-3">
                  <h3 class="h5">Exceptional Photography</h3>
                  <p class="mb-0">Delivering high-quality images that bring your moments and ideas to life.</p>
                </div>
              </div>
              <div class="d-flex pb-3 mb-2 mb-xl-3">
                <div class="text-body-secondary pt-1">03</div>
                <div class="ps-3">
                  <h3 class="h5">Web Development & Hosting</h3>
                  <p class="mb-0">Modern, responsive websites and reliable hosting to support your online presence.</p>
                </div>
              </div>
              <div class="d-flex mb-2 mb-xl-3">
                <div class="text-body-secondary pt-1">04</div>
                <div class="ps-3">
                  <h3 class="h5">IT Support</h3>
                  <p class="mb-0">Dependable IT support to keep your systems running smoothly and securely.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="swiper pb-2 pb-sm-3 pb-lg-4" data-swiper-options='{
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="card border-0 mb-4">
                  <div class="card-body">
                    <div class="d-flex align-items-center mb-3"><img class="rounded-circle" src="assets/img/avatar/24.jpg" width="60" alt="Esther Howard" />
                      <div class="ps-3">
      ...
      <section class="bg-primary py-5" data-bs-theme="dark">
        <div class="container pt-lg-2 pt-xl-4 pt-xxl-5 pb-1 pb-sm-3">
          <div class="row pt-sm-3 pt-md-4">
            <div class="col-md-6 col-xl-5 offset-xl-1">
              <h2 class="display-3">Ready to take your online presence to the next level?</h2>
            </div>
            <div class="col-md-6 col-lg-5 col-xl-4 offset-lg-1">
              <p class="text-body fs-xl pb-4 mb-2 mb-lg-3">At Homiez, we combine creativity, technology, and expertise to deliver outstanding solutions for your visual and digital needs.</p>
              <button class="btn btn-danger" type="button">Book a call</button>              
            </div>
          </div>
          <div class="d-none d-md-block text-center mt-n5">
            <svg class="text-danger ms-lg-5" width="171" height="97" viewBox="0 0 171 97" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
