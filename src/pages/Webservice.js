              ...
              <a class="card bg-secondary border-0 h-100 text-center text-decoration-none" href="#">
                <div class="card-body">
                  <svg class="d-block mx-auto mb-4" width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="text-warning" d="..."></path>
                    <path class="text-primary" d="..."></path>
                  </svg>
                  <h3>Web Development</h3>
                  <p class="card-text">High-quality web development services tailored to your business needs.</p>
                </div>
            ...
            <div class="swiper-slide h-auto">
              <a class="card bg-secondary border-0 h-100 text-center text-decoration-none" href="#">
                <div class="card-body">
                  ...
                  <p class="card-text">Custom mobile applications to elevate your digital presence.</p>
                </div>
                <div class="card-footer border-0 px-0 pt-0 pb-4 mb-3">
                  <div class="btn btn-icon btn-outline-primary rounded-circle stretched-link">
                    <i class="ai-arrow-right"></i>
            ...
            <div class="swiper-slide h-auto">
              <a class="card bg-secondary border-0 h-100 text-center text-decoration-none" href="#">
                <div class="card-body">
                  ...
                  <h3>UI/UX Design</h3>
                  <p class="card-text">Intuitive and user-centered design solutions for your applications.</p>
                </div>
                <div class="card-footer border-0 px-0 pt-0 pb-4 mb-3">
                  <div class="btn btn-icon btn-outline-primary rounded-circle stretched-link">
                    <i class="ai-arrow-right"></i>
            ...
            <div class="swiper-slide h-auto">
              <a class="card bg-secondary border-0 h-100 text-center text-decoration-none" href="#">
                <div class="card-body">
                  ...
                  <p class="card-text">Boost your online presence with our effective marketing strategies.</p>
                </div>
                <div class="card-footer border-0 px-0 pt-0 pb-4 mb-3">
                  <div class="btn btn-icon btn-outline-primary rounded-circle stretched-link">
                    <i class="ai-arrow-right"></i>
            ...
            <div class="swiper-slide h-auto">
              <a class="card bg-secondary border-0 h-100 text-center text-decoration-none" href="#">
                <div class="card-body">
                  ...
                  <h3>Branding</h3>
                  <p class="card-text">Create a unique brand identity to stand out in the market.</p>
                </div>
                <div class="card-footer border-0 px-0 pt-0 pb-4 mb-3">
                  <div class="btn btn-icon btn-outline-primary rounded-circle stretched-link">
                    <i class="ai-arrow-right"></i>
        ...
        <div class="row align-items-center pt-xl-2 pb-5 mb-lg-2 mb-xl-3 mb-xxl-4">
          <div class="col-md-7 col-lg-6 mb-4 mb-md-0">
            <a class="d-block position-relative" href="portfolio-single-v1.html">
              ...
              <img class="d-block position-relative z-2 mx-auto" src="assets/img/portfolio/list/06.png" width="636" alt="Image" data-aos="fade-in" data-aos-duration="400" data-aos-offset="250" />
            </a>
          </div>
          <div class="col-md-5 col-xl-4 offset-lg-1" data-aos="fade-up" data-aos-duration="400" data-aos-offset="170">
            <div class="ps-md-3 ps-lg-0">
              <img class="d-block d-dark-mode-none mb-2 mb-lg-3" src="assets/img/portfolio/brands/champion-blue-dark.svg" alt="Champion" />
              <img class="d-none d-dark-mode-block mb-2 mb-lg-3" src="assets/img/portfolio/brands/champion-blue-light.svg" alt="Champion" />
        ...
        <div class="row align-items-center pt-xl-2 pb-5 mb-lg-2 mb-xl-3 mb-xxl-4">
          <div class="col-md-7 col-lg-6 mb-4 mb-md-0">
            <a class="d-block position-relative" href="portfolio-single-v1.html">
              ...
              <img class="d-block position-relative z-2 mx-auto" src="assets/img/portfolio/list/07.png" width="636" alt="Image" data-aos="fade-in" data-aos-duration="400" data-aos-offset="250" />
            </a>
          </div>
          <div class="col-md-5 col-xl-4 offset-lg-1" data-aos="fade-up" data-aos-duration="400" data-aos-offset="170">
            <div class="ps-md-3 ps-lg-0">
              <img class="d-block mb-2 mb-lg-3" src="assets/img/portfolio/brands/foster-green.svg" alt="Foster" />
        ...
        <div class="row align-items-center pt-xl-2 pb-5 mb-lg-2 mb-xl-3 mb-xxl-4">
          <div class="col-md-7 col-lg-6 mb-4 mb-md-0">
            <a class="d-block position-relative" href="portfolio-single-v1.html">
              ...
              <img class="d-block position-relative z-2 ms-auto" src="assets/img/portfolio/list/08.png" width="636" alt="Image" data-aos="fade-in" data-aos-duration="400" data-aos-offset="250" />
            </a>
          </div>
          <div class="col-md-5 col-xl-4 offset-lg-1" data-aos="fade-up" data-aos-duration="400" data-aos-offset="170">
            <div class="ps-md-3 ps-lg-0">
              <img class="d-block mb-2 mb-lg-3" src="assets/img/portfolio/brands/boost.svg" alt="Boost" />
        ...
        <div class="container py-lg-2 py-xl-4 py-xxl-5">
          <div class="row mt-1 pt-sm-2 pt-md-3 pt-lg-4">
            ...
            <div class="col-lg-5 mb-5 mb-lg-0" data-aos="fade-up">
              ...
              <p class="pb-1 pb-md-0 mb-4 mb-md-5">We offer the best solutions tailored to your needs with unmatched quality and professionalism.</p>
              <h3 class="mb-4">Send us your request!</h3>
            ...
            {/* <!-- Benefits --> */}
            <div class="col-lg-7 col-xl-6 offset-xl-1" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="col" data-aos="fade-up" data-aos-delay="100">
                  <div class="card border-0 mb-4">
                    <div class="card-body">
                      ...
                      <h3 class="h4" style={{ maxWidth: '180px'}}>Work Across Time Zones</h3>
                      <p class="card-text fs-sm">Seamless communication, no matter where you or your clients are. We operate across all time zones.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col" data-aos="fade-up" data-aos-delay="200">
                  <div class="card border-0 bg-primary" data-bs-theme="dark">
                    <div class="card-body">
                      ...
                      <h3 class="h4" style={{ maxWidth: '180px'}}>Flexible Work Terms</h3>
                      <p class="card-text fs-sm">We offer flexible work terms, adapting to your schedule for the best collaboration experience.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col" data-aos="fade-up" data-aos-delay="400">
                  <div class="card border-0 mb-4">
                    <div class="card-body">
                      ...
                      <h3 class="h4" style={{ maxWidth: '180px'}}>Comprehensive Service</h3>
                      <p class="card-text fs-sm">A full spectrum of services to cater to all your needs in one place.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col" data-aos="fade-up" data-aos-delay="500">
                  <div class="card border-0 bg-primary" data-bs-theme="dark">
                    <div class="card-body">
                      ...
                      <h3 class="h4" style={{ maxWidth: '180px'}}>Challenges? We Solve Them</h3>
                      <p class="card-text fs-sm">Nothing is too difficult for us. We rise to every challenge to bring you the best results.</p>
                    </div>
                  </div>
                </div>
              </div>
